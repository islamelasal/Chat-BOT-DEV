...
- **كنز الشوا** ✅ مثبت كبوت افتراضي: البياع المصري النصوح (1973) — شخصية كاملة بترحيب واقتراحات ورد احتياطي، نموذج `gemini-3-flash-preview`، تأريض بأول 8 منتجات من الكتالوج، **خوارزمية ترشيح منتجين أسفل كل إجابة** (فئة/عنوان/عروسة/عروض/ماركة)، وقراءة صوتية 🔊 (ar-EG، rate 0.95).
